  ...
  return (
    <div className='pt-20'>
      <div className='flex flex-col justify-center items-center'>
        ...
        />
        <p className='text-4xl mt-8 mb-3'>{profile.handle}</p>
        <p></p>
        <p className='text-center text-xl font-bold  mb-5 w-3/4'>"{profile.bio}"</p>
        {
            publications.map(pub => (
              <div key={pub.id} className='shadow p-5 text-sm rounded mb-8 bg-accent w-2/3'>
